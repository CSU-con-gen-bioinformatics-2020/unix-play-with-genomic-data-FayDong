...
```{bash}
ls sam | wc
## ls -dl sam | wc, why it shows a different result?
```
...
## copy_of_R1_all_via_cat.fq.gz is a file or directory?
```
...
```{bash}
shasum (gzip R1_all_via_gzcat.fq; echo) copy_of_R1_all_via_cat.fq.gz
